...
<div id="welcome-center-section" class="section">
	...
	<p>
		<?php if ( $welcome['last_time_signin'] == '0000-00-00 00:00:00' ): ?>
			这是您第一次使用该系统, 您可以单击<a href="<?php echo base_url('home#profile'); ?>">此处</a>修改您的密码.	
		<?php else: 
			$time = strtotime($welcome['last_time_signin']);
		?>
			上次访问时间: <strong><?php echo date('Y年m月d日 H:i',$time); ?></strong>
		<?php endif ?>
	</p>
